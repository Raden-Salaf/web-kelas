    ...
    <div class="glass rounded-2xl p-6 mb-8" x-data="waWidget()">
        ...
        <div x-show="pesan" x-transition class="space-y-4">
            ...
            <div class="flex flex-wrap gap-3">
                ...
                {{-- Tombol kirim ke WA grup --}}
                @if (\App\Models\SiteSetting::getValue('whatsapp_group'))
                    <a :href="waGrupLink()" target="_blank"
        ...
        function waWidget() {
            return {
                ...
                async generate() {
                    ...
                    this.pesan = '';
                    try {
                        const res = await fetch('{{ route('admin.wa.message') }}');
                ...
                waGrupLink() {
                    // Buka link grup WA — admin bisa langsung paste pesan di sana
                    return '{{ \App\Models\SiteSetting::getValue('whatsapp_group', '#') }}';
                }
            }
        }
    </script>
